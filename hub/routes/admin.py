...
def keepalive_health():
    ...
    for acct in accounts:
        ...
        result.append({
            ...
            # SAPI ping fields (lightweight /system/information?action=get fired every ~20 min)
            "last_ping_at":         ka_st.get("last_ping_at"),
            "ping_status":          ka_st.get("ping_status", "unknown"),
