...
class PosterService {
  // M-19: dedup concurrent downloads for the same titleId.
  // Without this, two callers for the same poster race to write the same file
  // — the slower write can corrupt or truncate the cached image.
