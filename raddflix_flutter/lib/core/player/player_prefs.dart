...
class PlayerPrefs {
  ...
  // ── PiP ──────────────────────────────────────────────────────────────────
  /// BB4: when true, pressing back during playback enters PiP instead of popping.
  ...
  PlayerPrefs copyWith({
    ...
    dualSubtitleEnabled: dualSubtitleEnabled ?? this.dualSubtitleEnabled,
      ...
      pipOnMinimize:               pipOnMinimize               ?? this.pipOnMinimize,
  ...
  static Future<PlayerPrefs> load() async {
    ...
    return PlayerPrefs(
      ...
      subtitleFontSize:       s.getDouble('${_p}sub_font_size')   ?? 22.0,
      ...
      pipOnMinimize:               s.getBool('${_p}pip_on_minimize')      ?? true,
  ...
  Future<void> save() async {
    ...
    await Future.wait([
      ...
      s.setBool('${_p}pip_on_minimize',    pipOnMinimize),
