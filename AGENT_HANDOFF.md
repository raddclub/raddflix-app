...
Updated: 2026-06-18 (FIX-VF-BLACKSCREEN) | Flask running port 5000 at /opt/jazzmax/radd-hub
...
- **Flutter app: All known bugs fixed including FIX-VF-BLACKSCREEN (month-long blank screen root cause). Player UX improved (8 features + icon compat fix). APK builds green — last success run#1099/1100 commit 91e52dc. FIX-VF-BLACKSCREEN at commit cd241fc (build not yet triggered).
